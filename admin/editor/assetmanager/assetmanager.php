...
function selectFile(index)
	...
	//document.getElementById("inpSource").value="http://mls-dentalcosmetics.com/admin/editor/assets"+sFile_RelativePath;
	...
	if(sFile_Extension.toUpperCase()=="GIF" || sFile_Extension.toUpperCase()=="JPG" || sFile_Extension.toUpperCase()=="PNG")
		{
		//sHTML = "<img src=\"" + "http://mls-dentalcosmetics.com/admin/editor/assets" + sFile_RelativePath + "\" >"
sHTML = "<img src=\"" + "http://mls-dentalcosmetics.com/admin/editor/assets" + sFile_RelativePath + "\" >"
		}
	//SWF
