...
}; Calendar.prototype.callCloseHandler = function () { if (this.onClose) { this.onClose(this); if(this.source != undefined || this.dest != undefined){getAge(this.source,this.dest);}}
