	...
	class TCPDF {
		...
		*/
		...
		public function Header() {
			...
			$this->SetX(0);
            $this->Cell($this->getPageWidth(), $cell_height, $headerdata['title'], 0, 1, C);
//            $this->ce
			// header string
			$this->SetFont($headerfont[0], $headerfont[1], $headerfont[2]);
			$this->SetX(0);
			$this->MultiCell($this->getPageWidth(), $cell_height, $headerdata['string'], 0, 'C', 0, 1, 0, 0, true, 0);
...
//			set_magic_quotes_runtime($mqr);
     ...
     */    
	function Image2($file, $w=0, $x=null, $y=null,  $h=0, $type='', $link='')
{
